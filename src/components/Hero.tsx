            ...
            <div className="relative aspect-[8/7] w-full max-w-[480px] bg-white p-3 rounded-[2rem] shadow-[0_24px_48px_-12px_rgba(0,0,0,0.12)] overflow-hidden border border-white/80">
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 glass-card rounded-2xl border border-white/40 shadow-xl">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-black text-foreground text-sm leading-tight">Years Experience</h3>
                    <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Proven Expertise</p>
                  </div>
                </div>
              </div>
            </div>
